...
ActiveRecord::Schema.define(version: 20151117045421) do
  ...
  add_index "spendings", ["year_of_spending", "month_of_spending", "day_of_spending"], name: "spendings_on_year_month_day", using: :btree
